...
st.sidebar.header("👍😊 :violet[**WELCOME TO DASHBOARD**]")
...
if selected == "Home":
    st.image("head.png")
    st.markdown("# :violet[Data Visualization and Exploration Tool]")
    st.markdown("## :violet[A Interactive and User-Friendly Tool Using Streamlit and Plotly]")
    col1,col2 = st.columns([3,2],gap="medium")
    with col1:
        st.write(" ")
        st.write(" ")
        st.markdown("### :violet[Domain :] Mine")
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("**:violet[Phone_Pe_Pulse_Visualization_and_Exploration GitHub link]** ⬇️")
        st.write("https://github.com/Preethi3499/Phone_Pe_Pulse_Visualization_and_Exploration")
        st.write("**:violet[Pride & Beyond: Celebrating diversity and allyship at PhonePe]** ⬇️")
        st.write("https://www.phonepe.com/blog/")
